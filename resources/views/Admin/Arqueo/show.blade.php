...
<style>    
    ...
    /* table en span */
    .asiento_left,.asiento_right{
        height: 165px;
    }

    .asiento_left table,.asiento_right table
    {
        margin:10px 3px;
        /* padding:3px; */
    }     

    .asiento_left table td,.asiento_right table td{
        padding-left:3px !important;
        /* border:1px solid lightgray; */
    }  
    
    .asiento_left table td:nth-child(even),
    .asiento_right table td:nth-child(even){
        border-left:none !important;
        border-right:none !important;
    }
    .asiento_left table td:nth-child(odd),
    .asiento_right table td:nth-child(odd){
        border-left:none !important;
        border-right:none !important;
    }

    .asiento_left table tr:last-child td,
    .asiento_right table tr:last-child td{
        border-bottom:none !important;        
    }

    .asiento_left table td,.asiento_right table td,
    .asiento_left table input,.asiento_right table input
    {
        text-align:left !important;
    }
    /* .asiento_left table input{
...
<!-- js -->
<script src="{{asset('js/vistas/paginacion_show/arqueo.js')}}"></script>