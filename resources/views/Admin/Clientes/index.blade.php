...
@section('contenido')
    ...
    @include('Admin.Clientes.session_div.index')
    <div id="clientes">    
        <table id="principal">
            <tr class="head">
                <td>Id</td>
    ...
    <div id="confirm">
        <table>
            <tr><td class="center" colspan="2">Está a punto de eliminar el cliente, no lo podrá recuperar</td></tr>
...
<script src="{{asset('js/vistas/eliminar/cliente.js')}}"></script>