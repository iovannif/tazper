	...
	{!! Form::open(['url'=>'/Descuento', 'method'=>'post', 'autocomplete'=>'off', 'spelcheck'=>'false']) !!}
		...
		<table class="sobre">
			<tr><td>
				...
				<tr class="porc_todos">
					<td>
						Porcentaje: <input type="number" id="porc_tod" minlenght="1" maxlenght="2" max="95" min="5" step="5" onkeypress="if(this.value.length==2) return false;" required> %
						<span class="error error_porc"></span>
					</td>
				</tr>	
