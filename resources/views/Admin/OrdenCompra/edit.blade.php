    ...
    <div class="detalle">
        <table id="detalle">
            ...
            <tr>
                ...
                <td><input type="number" name="OC_SubTot" value="{{$orden->OC_SubTot}}" disabled style="background: #fff; padding: 5px 0;"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="number" name="OC_Iva" step="500" max="1000000" min="0" value="{{$orden->OC_Iva}}" onKeyPress="if(this.value.length==7) return false;"></td>
            </tr>
            
            <tr>
                <td colspan="2" class="m_l">Envío</td>
                <td><input type="number" name="OC_Env" step="500" max="1000000" min="0" value="{{$orden->OC_Env}}"onKeyPress="if(this.value.length==7) return false;"></td>
            </tr>
            
            <tr>
                <td colspan="2" class="m_l">Otro</td>
                <td><input type="number" name="OC_Otr" step="500" max="1000000" min="0" value="{{$orden->OC_Otr}}"onKeyPress="if(this.value.length==7) return false;"></td>
            </tr>
            
            <tr>
                <td colspan="2" class="m_l">Total</td>
                <td><input type="number" name="OC_Tot" step="500" max="1000000" min="0" style="border-bottom-right-radius:4px;" value="{{$orden->OC_Tot}}" onKeyPress="if(this.value.length==7) return false;"></td>
            </tr>
        </table>
    </div>    
@endsection
