...
<div class="detalle">
    <table id="detalle">
        ...
        <tr>
            ...
            <td><input type="text" name="OC_Subtotal" size="7" value="{{$orden->OC_SubTot}}" disabled></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" name="OC_Envio" size="7" value="{{$orden->OC_Env}}" disabled></td>
        </tr>
        
        <tr>
            <td colspan="2" class="m_l">Otro</td>
            <td><input type="text" name="OC_Otro" size="7" value="{{$orden->OC_Otr}}" disabled></td>
        </tr>
        
        <tr>
            <td colspan="2" class="m_l">Total</td>
            <td><input type="text" name="OC_Total" style="border-bottom-right-radius:4px;" size="7" value="{{$orden->OC_Tot}}" disabled></td>
        </tr>
    </table>
</div>        
@include('Admin.OrdenCompra.js.user')
