...
<style>
    .id_cli{margin-right: -15px !important;}
...
@section('contenido')
    ...
    @include('Admin.PedidoCliente.user')
    ...
    <table class="detalle">                                        
        ...
        @foreach($detalles as $detalle)                        
            <tr class="body">
                ...
                <td><input class="der" type="text" size="7" value="{{$articulo->Art_PreVen}}" disabled></td>
                <td><input class="der" type="text" size="4" value="{{$detalle->PCD_ArtCant}}" disabled></td>   
                    ...
                    <td><input class="der" type="text" size="7" value="{{$importe=$detalle->PCD_ArtCant*$saldo}}" disabled></td>
                @endif            
                @endforeach
            </tr>                     
...
<script src="{{asset('js/vistas/paginacion_show/pedido_cliente.js')}}"></script>