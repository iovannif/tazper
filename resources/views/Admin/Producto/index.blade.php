...
@section('navegacion_1')
    ...
    <div id="nav3">
        ...
        <input type="text" class="filtro" id="filtro_idProd" placeholder="Id Pro" size="4" maxlength="4" spellcheck="false" autocomplete="off"> <!-- Id  -->
        ...
        <input type="text" class="filtro" id="filtro_Imp" placeholder="Impuesto" size="10" maxlength="10" spellcheck="false" autocomplete="off"> <!-- Id  -->
            <input type="hidden" name="_token" id="token" value="{{csrf_token()}}">
    </div>
@endsection
...
{{--@php
    ...
    return $producto->Art_ProdTip != 'Tazper';
    });
@endphp--}}

@section('contenido')
    @include('Admin.Producto.session_div.index')
    <div id="productos">
        <!-- registros -->
        <table id="principal">
            <tr class="head">
    ...
    <div id="mdf">
        <table>            
            ...
            <tr>
                <td class="center"><input type="number" step="500" min="500" max="1000000" id="aumentar" size="7" onKeyPress="if(this.value.length==7) return false;"></td>
                <td class="center"><input type="number" step="500" min="500" max="1000000" id="disminuir" size="7" onKeyPress="if(this.value.length==7) return false;"></td>
                <td class="center"><input type="number" step="500" min="500" max="1000000" id="establecer_pre" size="7" onKeyPress="if(this.value.length==7) return false;"></td>

                <!-- maxlength="7" text -->                
                
                <!-- onclick="if(this.value.length==7) return false;" -->
            </tr>
            <tr>
...
<script src="{{asset('js/vistas/mdf_msv_chck.js')}}"></script>
