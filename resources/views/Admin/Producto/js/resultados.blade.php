    ...
    <style onload="
        ...
        if(window.productos_chequeados-length!=0){
            ...
            if(typeof window.marcando_filtrados!='undefined'){
                // console.log('e '+window.productos_chequeados);
        ...
        if(window.productos_chequeados.length==window.result){
            $('#mf').css('display','none');         
        }else{
            $('#mf').css('display','inline');
        }   
...
<table id="principal">
    <tr class="head">
        ...
        <td>Venta</td>
        <td>Impuesto</td>
        <td id="opciones" colspan="4">Opciones</td> {{--session('art_cat')--}}
    </tr>
...
<div id="mf">
    ...
    <input type="checkbox" id="filtrados" onclick="
        ...
        // // if(window.productos_chequeados.length==window.most.length){
        //     //     $('#mf').css('display','none');
        //     // }            
        // console.log(window.result+' '+window.todos.length);
