<ul id="pedprov">    
    ...
    <!-- datos del ped -->        
        ...
        <style onload="//rellena venta
            ...
            //haces la venta cuando tenes
            //produciste para el pedido                                               
            ...
            if($('.excede').val()=='true'){
                // console.log('st:'+$('.excede').val());                
                // console.log('st:'+$('.art_st_0').val());                
                // console.log('cant:'+$('.art_cant_0').val());    
                $('#aviso').html('Excede stock');      
                // console.log($('.excede').val());     
            }else{
                    $('#aviso').html('&nbsp;');
                ...
                //liq            
                    iva5=iva5*0.05; //de los sub
                    iva10=iva10*0.10;

                    $('.cost_exentas').each(function(){
                        if($(this).val()==''){
                            cost_exe+=0;
                        }else{
                            cost_exe+=parseInt($(this).val());
                        }
                    });

                    $('.cost_iva_5').each(function(){
                        if($(this).val()==''){
                            cost_iva5+=0;
                        }else{
                            cost_iva5+=parseInt($(this).val());
                        }
                    });

                    $('.cost_iva10').each(function(){
                        if($(this).val()==''){
                            cost_iva10+=0;
                        }else{
                            cost_iva10+=parseInt($(this).val());
                        }
                    });

                    cost_iva5=cost_iva5*0.05; //porc de los cost
                    cost_iva10=cost_iva10*0.10;
                
                // var liq5=iva5-cost_iva5;
                // var liq10=iva10-cost_iva10;

                var liq5=cost_iva5;
                var liq10=cost_iva10;

                $('#liq5').val(liq5);
                $('#liq10').val(liq10);
                $('#totiva').val(liq10+parseInt(liq5));                
            }
        "></style>   
    @else <!-- si no existe -->
        <style onload=" //en blanco
            ...
            //opciones
            $('#busqueda,#art_cant').prop('disabled',false); 
