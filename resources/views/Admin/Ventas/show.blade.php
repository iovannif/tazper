...
@section('detalle')               
        ...
        foreach($productos as $prod){
            foreach($art as $a){
                if($a==$prod->Id_Art){
                    ...
                    $producto=Articulo::find($prod->Id_Art);
                    $producto->update([
                        'Art_St'=> $st+$cant[$j]                        
                    ]);                    
    ...
    {{--@php
        ...
        print_r($array);
            ...
            //print_r(array_values($array)); //indexes y valores
        //echo key($array); 
                //echo array_search('a', array_keys($array)); 
        echo array_search('b', $array); echo nl2br("\n");        
                            
        $array=array_flip($array);
        print_r($array); //echo key($array); //index actual

            //busca un valor determinado y devuelve su index
