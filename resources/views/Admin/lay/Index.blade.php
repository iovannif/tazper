...
<style>
    ...
    #finalizado,#cancelado,#cancela,#rechazo_act{
        position:fixed;
        top:35%;
        left:33%;
        background:#FCFCFC;
    ...
    #finalizado table,#cancelado table,#cancela table,#rechazo_act table{
        margin:auto;
        width: 100%;
    }
    ...
    #finalizado td,#cancelado td,#cancela td,#rechazo_act td{
        border:none;
    }
    .center{
        text-align:center;
