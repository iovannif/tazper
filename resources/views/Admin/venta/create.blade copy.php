...
@section('cabecera')    
    {!! Form::open(['id' => 'venta_form', 'url'=>'/Ventas', 'method'=>'post', 'autocomplete'=>'off', 'spellcheck'=>'false']) !!}
        ...
        <table class="tabla_cabecera">            
            <tr>
                <td>Fecha:</td>
                <td><input type="text" size="8" value="{{date('d/m/y')}}" disabled></td>

                <td class="col_sep">Hora:</td>
                <td><input type="text" size="5" value="{{date('H:i')}}" disabled></td>
            ...
            <tr>                
                ...
                <td>
                    <input type="text" size="7" name="Ven_Fact" value="{{$factura}}" disabled>
                ...
                <td>
                    <input type="text" size="15" name="descuento" disabled>
                    ...
                    <table class="hidden">
                    <tr>
                        <td><input class="desc_lp" type="text" value="{{$det->Id_Lp}}" disabled></td>
                        <td><input class="desc_cli" type="text" value="{{$det->Id_Cli}}" disabled></td>
                        <td><input class="desc_art" type="text" value="{{$det->Id_Art}}" disabled></td>
                        <td><input class="desc_cat" type="text" value="{{$det->Id_Cat}}" disabled></td>
                        <td><input class="desc_porc" type="text" value="{{$det->DD_Porc}}" disabled></td>                                                                                                                                                                            
                    </tr>
                    </table>
                    @endforeach
                    @endif
...
@section('detalle')
        ...
        <table class="detalle">            
			...
			<tr class="linea linea_1">
                ...
                <td>
                    <input type="text" id="pre_1" name="Pre_Art_1" class="precio" size="7" value="{{old('Pre_Art_1')}}" disabled>
                ...
                <td><input type="text" class="saldo" id="saldo_1" name="Art_Sal_1" size="7" value="{{old('Art_Sal_1')}}" disabled></td>
                ...
                <td>
                    <input type="text" class="iva_5" id="iva5_1" name="Art_Iva5_1" size="7" value="{{old('Art_Iva5_1')}}" disabled>
                    <input type="hidden" class="cost_iva_5" id="cost_iva5_1" name="ArtCost_Iva5_1" size="7" value="{{old('ArtCost_Iva5_1')}}" disabled>
                </td>
                <td>
                    <input type="text" class="iva10" id="iva10_1" name="Art_Iva10_1" size="7" value="{{old('Art_Iva10_1')}}" disabled>
            ...
            <tr class="linea linea_2">
                ...
                <td>
                    <input type="text" id="pre_2" class="precio" name="Pre_Art_2" size="7" value="{{old('Pre_Art_2')}}" disabled>
                ...
                <td><input type="text" class="saldo" id="saldo_2" name="Art_Sal_2" size="7" value="{{old('Art_Sal_2')}}" disabled></td>                
                ...
                <td>
                    <input type="text" class="iva_5" id="iva5_2" name="Art_Iva5_2" size="7" value="{{old('Art_Iva5_2')}}" disabled>
                    <input type="hidden" class="cost_iva_5" id="cost_iva5_2" name="ArtCost_Iva5_2" size="7" value="{{old('ArtCost_Iva5_2')}}" disabled>
                </td>
                <td>
                    <input type="text" class="iva10" id="iva10_2" name="Art_Iva10_2" size="7" value="{{old('Art_Iva10_2')}}" disabled>
            ...
            <tr class="linea linea_3">
                ...
                <td>
                    <input type="text" id="pre_3" class="precio" name="Pre_Art_3" size="7" value="{{old('Pre_Art_3')}}" disabled>
                ...
                <td><input type="text" class="saldo" id="saldo_3" name="Art_Sal_3" size="7" value="{{old('Art_Sal_3')}}" disabled></td>
                ...
                <td>
                    <input type="text" class="iva_5" id="iva5_3" name="Art_Iva5_3" size="7" value="{{old('Art_Iva5_3')}}" disabled>
                    <input type="hidden" class="cost_iva_5" id="cost_iva5_3" name="ArtCost_Iva5_3" size="7" value="{{old('ArtCost_Iva5_3')}}" disabled>
                </td>
                <td>
                    <input type="text" class="iva10" id="iva10_3" name="Art_Iva10_3" size="7" value="{{old('Art_Iva10_3')}}" disabled>
            ...
            <tr class="linea linea_4">
                ...
                <td>
                    <input type="text" id="pre_4" class="precio" name="Pre_Art_4" size="7" value="{{old('Pre_Art_4')}}" disabled>
                ...
                <td><input type="text" class="saldo" id="saldo_4" name="Art_Sal_4" size="7" value="{{old('Art_Sal_4')}}" disabled></td>
                ...
                <td>
                    <input type="text" class="iva_5" id="iva5_4" name="Art_Iva5_4" size="7" value="{{old('Art_Iva5_4')}}" disabled>
                    <input type="hidden" class="cost_iva_5" id="cost_iva5_4" name="ArtCost_Iva5_4" size="7" value="{{old('ArtCost_Iva5_4')}}" disabled>
                </td>
                <td>
                    <input type="text" class="iva10" id="iva10_4" name="Art_Iva10_4" size="7" value="{{old('Art_Iva10_4')}}" disabled>
            ...
            <tr class="linea linea_5">
                ...
                <td>
                    <input type="text" id="pre_5" class="precio" name="Pre_Art_5" size="7" value="{{old('Pre_Art_5')}}" disabled>
                ...
                <td><input type="text" class="saldo" id="saldo_5" name="Art_Sal_5" size="7" value="{{old('Art_Sal_5')}}" disabled></td>
                ...
                <td>
                    <input type="text" class="iva_5" id="iva5_5" name="Art_Iva5_5" size="7" value="{{old('Art_Iva5_5')}}" disabled>
                    <input type="hidden" class="cost_iva_5" id="cost_iva5_5" name="ArtCost_Iva5_5" size="7" value="{{old('ArtCost_Iva5_5')}}" disabled>
                </td>
                <td>
                    <input type="text" class="iva10" id="iva10_5" name="Art_Iva10_5" size="7" value="{{old('Art_Iva10_5')}}" disabled>
            ...
            <tr class="linea linea_6">
                ...
                <td>
                    <input type="text" id="pre_6" class="precio" name="Pre_Art_6" size="7" value="{{old('Pre_Art_6')}}" disabled>
                ...
                <td><input type="text" class="saldo" id="saldo_6" name="Art_Sal_6" size="7" value="{{old('Art_Sal_6')}}" disabled></td>
                ...
                <td>
                    <input type="text" class="iva_5" id="iva5_6" name="Art_Iva5_6" size="7" value="{{old('Art_Iva5_6')}}" disabled>
                    <input type="hidden" class="cost_iva_5" id="cost_iva5_6" name="ArtCost_Iva5_6" size="7" value="{{old('ArtCost_Iva5_6')}}" disabled>
                </td>
                <td>
                    <input type="text" class="iva10" id="iva10_6" name="Art_Iva10_6" size="7" value="{{old('Art_Iva10_6')}}" disabled>
            ...
            <tr class="linea linea_7">
				...
				<td>
                    <input type="text" id="pre_7" class="precio" name="Pre_Art_7" size="7" value="{{old('Pre_Art_7')}}" disabled>
                ...
                <td><input type="text" class="saldo" id="saldo_7" name="Art_Sal_7" size="7" value="{{old('Art_Sal_7')}}" disabled></td>                
                ...
                <td>
                    <input type="text" class="iva_5" id="iva5_7" name="Art_Iva5_7" size="7" value="{{old('Art_Iva5_7')}}" disabled>
                    <input type="hidden" class="cost_iva_5" id="cost_iva5_7" name="ArtCost_Iva5_7" size="7" value="{{old('ArtCost_Iva5_7')}}" disabled>
                </td>
                <td>
                    <input type="text" class="iva10" id="iva10_7" name="Art_Iva10_7" size="7" value="{{old('Art_Iva10_7')}}" disabled>
            ...
            <tr class="linea linea_8">
				...
				<td>
                    <input type="text" id="pre_8" class="precio" name="Pre_Art_8" size="7" value="{{old('Pre_Art_8')}}" disabled>
                ...
                <td><input type="text" class="saldo" id="saldo_8" name="Art_Sal_8" size="7" value="{{old('Art_Sal_8')}}" disabled></td>
                ...
                <td>
                    <input type="text" class="iva_5" id="iva5_8" name="Art_Iva5_8" size="7" value="{{old('Art_Iva5_8')}}" disabled>
                    <input type="hidden" class="cost_iva_5" id="cost_iva5_8" name="ArtCost_Iva5_8" size="7" value="{{old('ArtCost_Iva5_8')}}" disabled>
                </td>
                <td>
                    <input type="text" class="iva10" id="iva10_8" name="Art_Iva10_8" size="7" value="{{old('Art_Iva10_8')}}" disabled>
