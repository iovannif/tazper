...
<body>
    ...
    <table class="cabecera">
        ...
        <tr>            
            ...
            <td><input type="text" size="10" value="{{$ven->Ven_Tot}} Gs."></td>
        </tr>        
    ...
    <table class="det">
        <tr> 
            ...
            <td class="head">Descuento (día)</td>
        ...
        <tr>
            <td><input type="text" size="25" value="{{$cob_det->CD_Art}}"></td>
            <td><input type="text" class="num" size="7" value="{{$cob_det->CD_ArtPre}}"></td>
            <td><input type="text" class="num" size="3" value="{{$cob_det->CD_ArtCant}}"></td>
            
            <td>
                @if($cob_det->CD_ArtDesc!='')
                <input type="text" class="num" size="3" value="{{$cob_det->CD_ArtDesc}}%">
                @endif
            </td>
            
            <td><input type="text" class="num" size="7" value="{{$cob_det->CD_ArtTot}}"></td>                                                
        </tr>
        @endforeach
    </table>
</body>
