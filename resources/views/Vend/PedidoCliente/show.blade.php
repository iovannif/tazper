    ...
    <table class="detalle">                                        
        ...
        @foreach($detalles as $detalle)                        
            <tr class="body">
                ...
                <td><input type="text" class="der" size="7" value="{{$articulo->Art_PreVen}}" disabled></td>
                <td><input type="text" class="der" size="4" value="{{$detalle->PCD_ArtCant}}" disabled></td>   
                    ...
                    <td><input type="text" class="der" size="7" value="{{$importe=$detalle->PCD_ArtCant*$saldo}}" disabled></td>
                @endif            
                @endforeach
            </tr>                     
